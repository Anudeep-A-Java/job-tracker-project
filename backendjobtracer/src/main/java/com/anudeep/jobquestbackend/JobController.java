...
public ResponseEntity<List<Job>> getJobsByCandidateEmail(@PathVariable String email) {
    return new ResponseEntity<>(jobService.getJobsByCandidateEmail(email), HttpStatus.OK);
}
